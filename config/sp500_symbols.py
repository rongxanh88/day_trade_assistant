...
SP500_SYMBOLS = [
    ...
    "DFS", "ABNB", "PNC", "ORLY", "APH", "MPC", "EMR", "ITW", "FDX", "PSA",
    ...
    "LHX", "DHR", "MMM", "OKE", "HES", "KVNE", "EA", "CTAS", "PWR", "ACGL",
    ...
    "WDC", "CBOE", "MAA", "FFIV", "BXP", "ZBRA", "TRV", "CHRW", "NI", "PKI",
    "SWK", "DRI", "CTRA", "ALLE", "BR", "PKG", "LYV", "AEE", "MKC", "DOW",
    "SOLV", "WBA", "EPAM", "CPT", "UHS", "CDW", "CAG", "DXC", "INCY", "CTLT",
